...
contract TestCosmoCoinIcoUnitMain_1 {
    ...
    function testMainBonus1() public {
        ...
        // 1 finney
        cosmoCoinIco.call.value(1 finney)();
        expectedBalance = expectedBalance + 10000 finney;
        balance = cosmoCoinIco.cosmoCoin().balanceOf(this);
        Assert.equal(balance, expectedBalance, "");

        cosmoCoinIco.endMainRound();
        Assert.equal(ETH_FUND_WALLET.balance, 1 finney, "final balance");
    }
}
