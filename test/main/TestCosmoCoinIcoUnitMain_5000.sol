...
contract TestCosmoCoinIcoUnitMain_5000 {
    ...
    function testMainBonus5000() public {
        ...
        // Main round
        cosmoCoinIco.startMainRound();

        // 4399 finney. Make EarlyBird total 5000 finney.
        cosmoCoinIco.call.value(4399 finney)();
        expectedBalance += 43990000 finney;
        balance = cosmoCoinIco.cosmoCoin().balanceOf(this);
        Assert.equal(balance, expectedBalance, "");

        cosmoCoinIco.endMainRound();
        Assert.equal(ETH_FUND_WALLET.balance, 4399 finney, "final balance");
    }
}
