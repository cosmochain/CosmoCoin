...
contract TestCosmoCoinIcoUnitFull_others {
    ...
    function testFullOthers() public {
        // Presale
        ...
        cosmoCoinIco.call.value(20000 finney)();
        ...
        Assert.equal(cosmoCoinIco.cosmoCoin().balanceOf(RESERVE_WALLET), 7000 * 10000 finney, "reserve pool");
    }
}
