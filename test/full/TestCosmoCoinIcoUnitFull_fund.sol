...
contract TestCosmoCoinIcoUnitFull_fund {
    ...
    function testFullFund() public {
        ...
        cosmoCoinIco.call.value(10000 finney)();
        expectedBalance = expectedBalance + 100000000 finney;
        balance = cosmoCoinIco.cosmoCoin().balanceOf(this);
        Assert.equal(balance, expectedBalance, "");
        cosmoCoinIco.endMainRound();

        // Deposit wallet
        cosmoCoinIco.finishInvestment();
        Assert.equal(ETH_FUND_WALLET.balance, 10000 finney, "");
    }
}
