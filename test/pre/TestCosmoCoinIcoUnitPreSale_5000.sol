...
contract TestCosmoCoinIcoUnitPreSale_5000 {
    ...
    function testPreSaleBonus5000() public {
        ...
        // The remaining portion. 5000 finney
        cosmoCoinIco.call.value(5000 finney)();
        expectedBalance += 60000000 finney;
        balance = cosmoCoinIco.cosmoCoin().balanceOf(this);
        Assert.equal(balance, expectedBalance, "");

        cosmoCoinIco.endPreSale();
        Assert.equal(ETH_FUND_WALLET.balance, 5000 finney, "final balance");
    }
}
