...
contract TestCosmoCoinIcoUnitPreSale_5 {
    ...
    function testPreSaleBonus5() public {
        ...
        // 5 finney
        cosmoCoinIco.call.value(5 finney)();
        expectedBalance = expectedBalance + 52500 finney;
        ...
        Assert.equal(ETH_FUND_WALLET.balance, 5 finney, "final balance");
    }
}
