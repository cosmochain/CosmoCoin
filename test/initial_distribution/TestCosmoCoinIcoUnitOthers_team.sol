...
contract TestCosmoCoinIcoUnitOthers_team {
    ...
    function testTeam() public {
        Assert.equal(cosmoCoinIco.cosmoCoin().balanceOf(COSMOCHAIN_TEAM_WALLET), 10000 * 10000 finney, "");
    }
}
